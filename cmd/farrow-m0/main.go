...
import (
	...
	"github.com/pgsty/farrow/internal/m0"
)

func main() {
	flags := flag.NewFlagSet("farrow-m0", flag.ExitOnError)
	...
	if flags.NArg() != 0 || *image == "" || *sha256 == "" || *workDir == "" {
		fmt.Fprintln(os.Stderr, "usage: farrow-m0 --image <absolute-qcow2> --sha256 <digest> --work-dir <empty-absolute-dir>")
		os.Exit(2)
	}
